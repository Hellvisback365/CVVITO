    ...
    <section id="home" className="relative h-screen flex items-center overflow-hidden">
      ...
      <div className="container max-w-7xl mx-auto px-6 z-10">
        <div className="flex flex-col space-y-6 md:w-3/4 lg:w-2/3">
          ...
          <motion.h2 
            className="text-2xl md:text-3xl lg:text-4xl font-poppins font-semibold text-gray-600 dark:text-gray-300"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.2 }}
          >
            Sviluppatore IA <span className="text-green-500 dark:text-green-400">in formazione</span>
          </motion.h2>
          ...
          >
            Specializzato in prototipazione di applicazioni basate su modelli linguistici (LLaMA, Mistral) 
            e soluzioni di raccomandazione conversazionale. Appassionato di tecnologie che fanno la differenza.
          </motion.p>
