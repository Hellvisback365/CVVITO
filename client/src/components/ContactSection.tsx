...
export const ContactSection = () => {
  ...
  const contactMutation = useMutation({
    ...
    onError: (error) => {
      toast({
        title: 'Errore',
        description: error instanceof Error ? error.message : 'Si è verificato un errore durante l\'invio del messaggio.',
        variant: 'destructive'
      });
    }
  });
    ...
    <section id="contact" ref={sectionRef} className="py-20 bg-gray-50 dark:bg-gray-900">
      <div className="container max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="max-w-2xl">Hai un progetto interessante o vuoi saperne di più sulle mie competenze? Contattami!</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg h-full">
              <h3 className="text-xl font-poppins font-semibold mb-6">Informazioni di Contatto</h3>
              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a href="mailto:info@vitopiccolo.dev" className="text-gray-600 dark:text-gray-400 hover:text-primary transition-colors duration-300">info@vitopiccolo.dev</a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">Bari, Italia</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <div className="flex space-x-4 mt-2">
                      <a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary transition-colors duration-300">
                        <Github size={20} />
                      </a>
                      <a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary transition-colors duration-300">
                        <Linkedin size={20} />
              ...
              <div className="mt-12">
                <h3 className="text-xl font-poppins font-semibold mb-6">Disponibilità</h3>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Attualmente sono disponibile per collaborazioni part-time e tirocini
                  nell'ambito dello sviluppo di intelligenza artificiale e applicazioni web innovative.
                </p>
                <div className="flex items-center space-x-2 text-green-500 dark:text-green-400">
                  ...
                  <span className="font-medium">Disponibile per nuovi progetti</span>
                </div>
              </div>
            </div>
          </motion.div>
